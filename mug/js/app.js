...
function reset() {
	...
	player1.pos = { x : canvasWidth / 2 - 90, y : canvasHeight - 30 };
	player1.palette = player1.SFF.palette; //.ACT[ 0 ];
	player1.right = 1;
	
	player2 = new player( resources[ 1 ] ); // Another character
	player2.pos = { x : canvasWidth / 2 + 90, y : canvasHeight - 30 };
